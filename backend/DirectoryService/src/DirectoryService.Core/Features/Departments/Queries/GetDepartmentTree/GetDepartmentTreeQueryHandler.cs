...
public class GetDepartmentTreeQueryHandler : IQueryHandler<
    ...
    Result<PagedResult<DepartmentTreeRootDto>, Error>>
{
    ...
    public async Task<Result<PagedResult<DepartmentTreeRootDto>, Error>> Handle(GetDepartmentTreeQuery query, 
        CancellationToken cancellationToken)
    {
        ...
        var rootDepartments = await connection
            .QueryAsync<DepartmentTreeRootDto, long, DepartmentTreeRootDto>(
                sql: sql,
                map: (dto, total) =>
                {
                    totalCount ??= total;
        ...
        return new PagedResult<DepartmentTreeRootDto>(
